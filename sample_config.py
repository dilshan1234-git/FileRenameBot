...
class Config(object):
    ...
    # log channel
    #LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1001991565239")
    ...
    DEF_WATER_MARK_FILE = ""
    # Database url
    DB_URI = os.environ.get("DATABASE_URL", "Mongodb url - mongodb+srv://dilfilter123:dilfilter123@cluster0.tq9uv2k.mongodb.net/?retryWrites=true&w=majority")
